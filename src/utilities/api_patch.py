"""
This is a patch module to temporarily fix the face_recognition import issue with the monkey patching method.
For the best performance, please try and install the face_recognition library using the requirements.txt file instead of
relying on the class wrapper FaceRecognitionModels.
...
if face_rec_path:
    ...
    print(
        f"Patched {face_rec_path} to continue even if face_recognition_models is not found"
    )
else:
